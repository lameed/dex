...
echo "create, read, update and delete equipment\n";
echo "create, read, update and delete part\n";
...
$this->_authManager->createOperation("deleteUser","remove a user from a group");
//create the lowest level operations for projects
$this->_authManager->createOperation("createEquipment","create a new equipment");
$this->_authManager->createOperation("readEquipment","read equipment information");
$this->_authManager->createOperation("updateEquipment","update equipment information");
$this->_authManager->createOperation("deleteEquipment","delete a equipment");
...
$role->addChild("readequipment");
$role->addChild("readpart");
$role->addChild("readconsumables");
