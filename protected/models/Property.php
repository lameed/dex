 ...
 */
class Property extends DextronImsActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('title', 'length', 'max'=>2000),
			array('create_time, update_time', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, subequipment_id, title, create_time, create_user_id, update_time, update_user_id', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->condition='subequipment_id=:subequipmentID';
		$criteria->params=array(':equipmentID'=>$this->equipment_id);
