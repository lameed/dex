...
$this->menu=array(
	...
	array('label'=>'Create Movement', 'url'=>array('movement/create', 'pid'=>$model->id)),
	array('label'=>'Create Maintenance', 'url'=>array('maintenance/create', 'pid'=>$model->id)),
	array('label'=>'Create Property', 'url'=>array('property/create', 'pid'=>$model->id)),
);
?>
