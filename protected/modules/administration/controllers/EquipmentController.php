...
class EquipmentController extends Controller
{
	...
	{
		$subcategoryDataProvider=new CActiveDataProvider('Subcategory', 
			array('criteria'=>array('condition'=>'equipment_id=:equipmentId','params'=>array(':equipmentId'=>$this->loadModel($id)->id),),
