...
class SupplierPartController extends Controller
{
	...
	{
		$model=new SupplierPart('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['SupplierPart']))
			$model->attributes=$_GET['SupplierPart'];
	 ...
	 * @return SupplierPart the loaded model
	 ...
	 * @param SupplierPart $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='supplier-part-form')
		{
