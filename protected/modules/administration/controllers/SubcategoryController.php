...
class SubcategoryController extends Controller
{
	...
	public function filters()
	{
		return array(
			...
			//'equipmentContext + create', //check to ensure valid equipment context
	...
	*/
	protected function loadEquipment($equipment_id) {
	//if the project property is null, create it based on input id
	if($this->_equipment===null)
	{
		$this->_equipment=Equipment::model()->findbyPk($equipment_id);
		if($this->_equipment===null)
		{
...
*/
public function filterEquipmentContext($filterChain)
{
//set the project identifier based on either the GET or POST input
//request variables, since we allow both types for our actions
$equipmentId = null;
if(isset($_GET['pid']))
$equipmentId = $_GET['pid'];
else
if(isset($_POST['pid']))
$equipmentId = $_POST['pid'];
